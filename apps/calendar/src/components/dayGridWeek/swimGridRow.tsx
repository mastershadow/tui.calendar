...
import type { Swimlane, WeekOptions } from '@t/options';
...
export function SwimGridRow({
  ...
  const rowTitleTemplate = `swimlaneTitle`;
  ...
  return (
    <Fragment>
      <div className={cls('panel-title')} style={dayGridLeftTheme}>
        <Template template={rowTitleTemplate} param={swimlane} />
      </div>
